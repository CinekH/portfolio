export const polishText = {
  HomeHello: "Cześć, nazywam się",
  HomeWho: "jestem początkującym web developerem",
  AboutMeText: `Ukończyłem kierunek Informatyka na Uniwersytecie Śląskim. Moją specjalizacją jest projektowanie 
  aplikacji webowych, czyli kierunek w którym się rozwijam. Interesuję się sportem, w szczególności piłką nożną i grami.`,
  NavigationHome: "START",
  NavigationAbout: "O MNIE",
  NavigationSkills: "TECHNOLOGIE",
  NavigationProjects: "PROJEKTY",
  NavigationContact: "KONTAKT",
  LevelsBeginner: "POCZĄTKUJĄCY",
  LevelsIntermediate: "ŚREDNIO ZAAWANSOWANY",
  LevelsUpperIntermediate: "ŚREDNIO ZAAWANSOWANY WYŻSZY",
  ...
  Projects: [
    {
      Name: "Steganografia",
      Details: `Projekt powstał jako przykład wybranej metody steganograficznej. Jest to technika polegająca na ukrywaniu informacji w nośniku,
       tak aby fakt jej ukrycia, jak i sama wiadomość były niewidoczne. Aplikacja daje użytkownikowi możliwość ukrycia informacji w formie tekstu
